...
window.Sprite3D = function (view/*:MovieClip=null*/, 
	...
	this.getView = function()/*:MovieClip*/ {
		return _view;
	}
	
	this.getRenderedX = function()/*:Number*/ {
		return _renderedX;
	}
	...
	this.getRenderedY = function()/*:Number*/ {
		return _renderedY;
	}
	...
	this.getRenderedZ = function()/*:Number*/ {
		return _renderedZ;
	}
