package com.arukadia.model.camera {
	...
	public class Camera {
		...
		private var _bindedProperties:Object = new Object();
		...
		public function bindProperties(x:String, y:String, z:String, visible:String):void {
			_bindedProperties.x       = x;
			_bindedProperties.y       = y;
			_bindedProperties.z       = z;
			_bindedProperties.visible = visible;
		}
		...
		private function getPointDistance(itemX:Number, itemY:Number, 
			...
			var distance:Number    = denominator / divisor;
			return distance;
			/*
